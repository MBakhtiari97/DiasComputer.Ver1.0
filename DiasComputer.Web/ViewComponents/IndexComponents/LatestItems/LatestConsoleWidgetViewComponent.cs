...
{
    public class LatestConsoleWidgetViewComponent : ViewComponent
    {
        private IProductRepository _productRepository;
        ICategoryRepository _categoryRepository;

        public LatestConsoleWidgetViewComponent(IProductRepository productRepository, ICategoryRepository categoryRepository)
        {
