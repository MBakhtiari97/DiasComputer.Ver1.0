...
namespace DiasComputer.DataLayer.Migrations
{
    ...
    [Migration("20220517112105_addIdentifierToNewsletter")]
    partial class addIdentifierToNewsletter
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiasComputer.DataLayer.Entities.SiteResources.EmailHistory", b =>
                {
            ...
            modelBuilder.Entity("DiasComputer.DataLayer.Entities.SiteResources.EmailType", b =>
                {
                    b.Property<int>("EmailTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DiasComputer.DataLayer.Entities.Users.NewsLetter", b =>
                {
                    ...
                    b.Property<string>("NWIdentifier")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("DiasComputer.DataLayer.Entities.SiteResources.EmailHistory", b =>
                {
                    b.HasOne("DiasComputer.DataLayer.Entities.SiteResources.EmailType", "EmailType")
                        .WithMany("Email")
